...
<html>
<head>
<title>Course Detail Report</title>
...
<form name="f1" action="vet_rptCourses.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Course Information [ Any Course ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tblcourse");
	while(rscode.next()){
