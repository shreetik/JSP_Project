...
<html>
<head>
<title>Staff Attendance Detail Report</title>
...
<form name="f1" action="vet_rptsAttends.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Staff Attendance Information [ Any Staff ID ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tblAttend");
	while(rscode.next()){
		code=rscode.getString("staff_id");
		%>
