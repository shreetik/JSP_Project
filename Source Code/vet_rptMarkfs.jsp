...
<html>
	<head>
		<title>Mark Folio Detail Report</title>
	</head>
	
	<body>
		
			  <center><font color="red" size="5" face="copperplate gothic"><b>Mark Folio Informatoin [ <%=name%> ]</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tblMarkFolio where roll_no='"+roll+"'");
