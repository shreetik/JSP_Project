...
<form name="f1" action="vet_rptUnivs.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>University Information [ Any University ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tbluniv");
	while(rscode.next()){
		code=rscode.getString("univname");
		%>
