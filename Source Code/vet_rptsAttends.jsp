...
%>
<%
sid=request.getParameter("cmbdname");
%>
<html>
	<head>
	...
	<body>
			  ...
			  <center><font color="red" size="5" face="copperplate gothic"><b>Staff Attendance Informatoin [ <%=sname%> ]</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tblAttend where staff_id='"+sid+"'");
