...
%>
<%
dname=request.getParameter("cmbcode");
%>
<html>
	<head>
	...
	<body>
			  ...
			  <center><font color="red" size="5" face="copperplate gothic"><b>Department Informatoin [ <%=dname%> ]</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tbldept where deptname='"+dname+"'");
