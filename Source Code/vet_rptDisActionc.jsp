...
<form name="f1" action="vet_rptDisActions.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Disciplinary Action Information [ Any Roll No. ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tbldisaction");
	while(rscode.next()){
