...
function showpofile(){
	window.location="vet_wslit_findc.jsp";
}
</script>
...
String refno,dat,roll,name,sex,course,sem,warning,btnup,btndel;
...
<%
 refno=request.getParameter("cmbref");
  ...
  warning=request.getParameter("txtwar");
...
<%
  ...
  try{
	  ...
	  stmtupdate.executeUpdate("update vet_tblwslit set date='"+dat+"',roll_no='"+roll+"',name='"+name+"',sex='"+sex+"',course='"+course+"',semester='"+sem+"',warning_for='"+warning+"' where ref_no='"+refno+"'  ");
	  %>
	 <div class="cc">
	 <img src="tick.png">
	 ...
	 <br>
	  ...
	  stmtdelete.executeUpdate("delete from vet_tblwslit where ref_no='"+refno+"'  ");
	  %>
	  <div class="cc">
	  <img src="delete.png">
