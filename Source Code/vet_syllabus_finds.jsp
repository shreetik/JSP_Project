...
String refn,cname,ccod,nos,sem,pcod,pname,fulm,crdt,btndel,btnup;
...
<%
refn=request.getParameter("cmbref");
...
<%
  ...
  try{
	  ...
	  stmtupdate.executeUpdate("update vet_tblsyllabus set ref_no='"+refn+"',c_name='"+cname+"',c_code='"+ccod+"',no_of_sem='"+nos+"',semester='"+sem+"',p_code='"+pcod+"',p_name='"+pname+"',full_mark='"+fulm+"',credit='"+crdt+"' where ref_no='"+refn+"'  ");
	  %>
	 <div class="cc">
	 <img src="tick.png">
	 ...
	 <br>
	  ...
	  stmtdelete.executeUpdate("delete from vet_tblsyllabus where ref_no='"+refn+"'  ");
	  %>
	  <div class="cc">
	  <img src="delete.png">
