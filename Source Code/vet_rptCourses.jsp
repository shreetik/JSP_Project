...
<html>
	...
	<body>
			  ...
			  <center><font color="red" size="5" face="copperplate gothic"><b>Course Informatoin [ <%=cname%> ]</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tblcourse where c_name='"+cname+"'");
