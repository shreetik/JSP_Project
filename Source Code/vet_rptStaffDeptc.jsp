...
<form name="f1" action="vet_rptStaffDepts.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Staff Information [ Any Department ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tblstaff");
	while(rscode.next()){
		code=rscode.getString("dept");
		%>
