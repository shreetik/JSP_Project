...
<%!
		   ...
		   Statement stmtView;
		   ResultSet rs1;
		   String ref,dat,roll,name,sex,course,sem,status;
		   int slno;
...
%>
<%
roll=request.getParameter("cmbdname");
%>
<html>
	<head>
	...
	<body>
			  ...
			  <center><font color="red" size="5" face="copperplate gothic"><b>Student Attendance Informatoin [ <%=name%> ]</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tblstuAttend where roll_no='"+roll+"'");
