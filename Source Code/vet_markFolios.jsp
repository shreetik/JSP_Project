...
Connection conn;
Statement stmtsave;
String refno,dat,roll,name,sex,course,pcod,credit,pname,sem,fmark,markob;
...
<%
  ...
  try{
	  ...
	  stmtsave.executeUpdate( "insert into vet_tblMarkFolio values( '"+refno+"','"+dat+"','"+roll+"','"+name+"','"+sex+"','"+course+"','"+pcod+"','"+credit+"','"+pname+"','"+sem+"','"+fmark+"','"+markob+"')" );
	%>
