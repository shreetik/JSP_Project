...
<form name="f1" action="vet_rptStuAdms.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Student Admission Information [ Any Registration No. ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tblstuadm");
	while(rscode.next()){
		code=rscode.getString("regi_no");
		%>
