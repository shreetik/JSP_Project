...
<html>
	<head>
		<title>Disciplinary Action Detail Report</title>
	</head>
	
	<body>
		
			  <center><font color="red" size="5" face="copperplate gothic"><b>Disciplinary Action Informatoin [ <%=name%> ]</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tbldisaction where roll_no='"+roll+"'");
