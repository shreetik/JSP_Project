...
<html>
	<head>
		<title>Staff Informatoin Report</title>
	</head>
	...
	<body>
			  ...
			  <center><font color="red" size="5" face="copperplate gothic"><b>Staff Informatoin</b></font></center>
	...
	try{
		...
		System.out.println("Unable to connect with Database "+sqe);
			 ...
			 try{
				...
				rs1=stmtView.executeQuery("Select * from vet_tblstaff");
