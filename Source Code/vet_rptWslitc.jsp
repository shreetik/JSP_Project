...
<form name="f1" action="vet_rptWslits.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Warning Slit Information [ Any Roll No. ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tblwslit");
	while(rscode.next()){
