...
<html>
<head>
<title>Syllabus Detail Report</title>
...
<form name="f1" action="vet_rptSyllabuss.jsp" method="get">
<table border="0" cellspacing="15" id="nav">
<tr>
<td align="center" colspan="4"><div class="uni"><p>Syllabus Information [ Any Course ]  </p></div></td>
</tr>
...
try{
	...
	rscode=stmtfillnum.executeQuery("select * from vet_tblsyllabus");
	while(rscode.next()){
		code=rscode.getString("c_name");
		%>
